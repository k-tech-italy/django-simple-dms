...
class DocumentGrant(models.Model):
    ...
    granted_permissions = ArrayField(models.CharField(max_length=1), default=list)
    ...
    def __str__(self) -> str:
        ...
        return f'{prefix}:{self.granted_permissions}:{self.document}'
...
class TagGrant(models.Model):
    ...
    defaults = ArrayField(models.CharField(max_length=1), default=list)
    granted_by_system = models.BooleanField(default=True)
...
class Document(models.Model):
    document = models.FileField(upload_to=f'{settings.MEDIA_ROOT}/documents/%Y/%m/%d')
    ...
    superuser_grants = models.CharField(max_length=5, default='CRUDS')
